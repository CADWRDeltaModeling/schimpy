...
Many schimpy utilities can be invoked as command line utilities and the most common of these is the `prepare_schism` command for the :ref:`preprocessor <preprocessor>` invoked like this::
