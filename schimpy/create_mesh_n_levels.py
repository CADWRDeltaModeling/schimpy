...
def create_arg_parser():
    ...
    description = (
        "Create a mesh file with the number of vertical levels",
        " as nodal values ",
    )
    parser = argparse.ArgumentParser(description=description)
    parser.add_argument("--hgrid", default="hgrid.gr3", help="Horizontal grid name")
    parser.add_argument("--vgrid", default="vgrid.in", help="Vertical grid file name")
    parser.add_argument("--output", default="n_levels.gr3", help="Output file name")
    return parser
