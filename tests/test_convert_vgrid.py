...
def test_convert_vmesh(datadir, tmp_path):
    old_vgrid_fn = datadir / 'vgrid.in.old'

    output_grid_fn1 = tmp_path / 'vgrid1.in.3d'
...
def test_compare_vmesh(datadir, tmp_path):
    new_vgrid_fn = datadir / 'vgrid.in.new'
    output_grid_fn2 = tmp_path / 'vgrid2.in.3d'
